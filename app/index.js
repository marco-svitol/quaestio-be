...
server(app, () =>{
	logger.info(`Quaestio backend server is running. Listening on port ${global.config_data.app.serverPort}, node_env is ${global.environment} and loglevel is ${global.config_data.app.loglevel}. MaxOPSResults is ${global.config_data.app.maxOPSResults}. UserInfoCacheTTLSeconds is ${global.config_data.app.userInfoCacheTTLSeconds} `)
})
